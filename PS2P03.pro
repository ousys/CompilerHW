...
cs((goto E),Code,Ain,Aout):-!,
	atom(E),
	get_assoc(E,Ain,X,Aout,X),
	Code=['\n\t\t jmp ',X].

cs((E1::E2),Code,Ain,Aout):-!,
	not(atom(E2)),
	cs(E2,Code2,Ain,Aaux),
	get_assoc(labelsuffix,Aaux,LabelSuffixIn,Aout,LabelSuffixOut),
	generateLabels([Lb1],LabelSuffixIn,LabelSuffixOut),
	put_assoc(E1,Aout,Lb1,Aout),
	Code1 = [ '\n',Lb1,':' ],
